...
ACTIVITY_OPTIONS = [
    ("Сидячая работа, без тренировок", "sedentary"),
    ("Сидячая работа + 1–3 тренировки", "light"),
    ("Активная работа или 3–5 тренировок", "moderate"),
    ("6–7 тренировок в неделю", "high"),
    ("Физический труд + тренировки", "athlete"),
]
# Для показа сохранённого профиля: ключ -> подпись.
ACTIVITY_RU = {
    "sedentary": "Сидячая работа, без тренировок",
    "light": "Сидячая работа + 1–3 тренировки",
    "moderate": "Активная работа или 3–5 тренировок",
